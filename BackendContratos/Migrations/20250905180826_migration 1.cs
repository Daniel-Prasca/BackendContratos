        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Polizas_Contratos_ContratoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servicios_Contratos_ContratoId",
                        column: x => x.ContratoId,
                        principalTable: "Contratos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Alertas_Polizas_PolizaId",
                        column: x => x.PolizaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Liquidaciones_Contratos_ContratoId",
                        column: x => x.ContratoId,
                        principalTable: "Contratos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Liquidaciones_Servicios_ServicioId",
                        column: x => x.ServicioId,
                        principalTable: "Servicios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Liquidaciones_Users_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Liquidaciones_ContratoId",
                table: "Liquidaciones",
                column: "ContratoId");

            migrationBuilder.CreateIndex(
                name: "IX_Liquidaciones_ServicioId",
                table: "Liquidaciones",
                column: "ServicioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Polizas_ContratoId",
                table: "Polizas",
                column: "ContratoId");

            migrationBuilder.CreateIndex(
                name: "IX_Servicios_ContratoId",
                table: "Servicios",
                column: "ContratoId");
        }
